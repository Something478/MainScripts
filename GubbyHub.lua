...
if Place == 88308889239232 or Place == 17574618959 then
    readTab:CreateParagraph({
        ...
        Content = "If you're gonna use genesis, go to the Genesis rigs tab, once you're done loading the hats and rigs, head to the Genesis tab and execute the scripts there!!"
    })
end
